        ...
        do {
            ...
            switch (menu) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    if (!nilaiQueue.isEmpty()) {
                        Nilai removedNilai = nilaiQueue.poll();
                        daftarNilai.remove(removedNilai);
                        System.out.println("Data dengan NIM " + removedNilai.mhs.nim + " berhasil dihapus.");
                    } else {
                        System.out.println("Tidak ada data nilai yang dapat dihapus.");
                    }
                    System.out.println("");
                    break;
                case 6:
